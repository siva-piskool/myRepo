...
const Campus:React.FC=()=>{
    ...
    <h1 className="pc-c1 pb-0">Campus</h1>
    <p className="pc-p1">
        <a href="campus#" title="Notable Indian Nobel Laureate for Physics, known for discovery of Raman Effect" id='cv-raman'>Sir CV Raman</a> Campus, is our state-of-the-art campus located in Karamchedu
